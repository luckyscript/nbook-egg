...
# Database: nbook-o
# Generation Time: 2019-04-10 02:50:58 +0000
# ************************************************************
...
VALUES
	...
	(10,'article','发个声，ThinkJS 并不是没人维护了，只是有些 PR 并不能立即合并，包括 PR 本身提出的需求我们都是需要讨论的，而且很不恰巧的是您的那个 PR 正好在年前几天发布的，我们要么就忙着年前的活儿要么就已经休假了，年后的上班时间也不统一，所以耽搁了，实际上我们正常小修小改的 PR 的处理是很快的。\n\n另外博客的话完全可以基于 ThinkJS 开发的 Firekylin https://firekylin.org 进行二次开发鸭，我们的后台参考了成熟的博客后台，维护了3年多了重构了3个版本，使用的是 React 16 + Ant Design 开发的，基本的功能都齐活了，非常适合二次开发！强烈推荐一下。\n\n最后的最后，再强调一下，ThinkJS 并不是没人维护了，因为进行了模块拆分，ThinkJS 主模块的更新频率变的非常低，但是其它模块的维护我们也都是有在正常进行的。其实大家根本不必担心没人维护的问题，我们内部也有大量的线上业务在使用 ThinkJS 框架开发的，所以停更什么的根本不太可能。以上~','怡红公子','i@imnerd.org',0,'53','http://zh.eming.li','2019-03-02 08:08:10'),
	(11,'article','@怡红公子 很抱歉之前发表了不当言论。我一直也是Thinkjs的忠实粉丝，感谢开源。','luckyscript','main.lukai@gmail.com',10,'53','http://www.luckyscript.me','2019-03-06 13:31:08'),
	(12,'article','@luckyscript 没关系，我并不是斥责博主的意思，只是因为实在是太多的人说这个事情所以想把事实解释给大家听，如有言语不当处还请海涵。其实这也是 ThinkJS 3 拆分模块之后带来的一个问题，我们也有想过使用 lerna 来做 mono 的方式来管理所有的模块，但是为了这个问题引入扁平化 repo 的概念感觉成本有点高。实际上 egg 也碰到了相同的问题，为了告诉用户他们还在跟新，他们开发了一个 egg-feed-bot 来收集所有的模块的 changelog 定时发文来处理的 https://github.com/eggjs/egg-feed-bot','怡红公子','i@imnerd.org',11,'53','http://zh.eming.li','2019-03-09 16:42:32');
...
VALUES
	(1,'2018-08-29 23:47:10','测试','https://www.luckyscript.me',1,74,'328c5605',1),
	(2,'2018-08-29 23:51:11','C语言字节对齐问题详解','https://www.cnblogs.com/clover-toeic/p/3853132.html',5,122,'de8a76ac',1),
	(3,'2018-08-30 08:54:20','正则表达式测试网站','https://regexr.com/',2,67,'16d2f97c',1),
	(4,'2018-08-30 11:53:56','node eventloop','https://cnodejs.org/topic/57d68794cb6f605d360105bf',6,151,'3da3389a',1),
	(5,'2018-08-30 21:09:27','C++ 引用计数技术及智能指针的简单实现','https://www.cnblogs.com/QG-whz/p/4777312.html',5,166,'304e3257',1),
	(6,'2018-08-31 15:16:45','五子棋AI教程第二版','https://github.com/lihongxun945/myblog/issues/11',2,119,'f883c3ee',1),
	(7,'2018-08-31 16:18:12','正则表达式30分钟入门教程','http://deerchao.net/tutorials/regex/regex-1.htm',2,105,'6172df17',1),
	(8,'2018-09-04 00:21:43','从暴力到 NAN 再到 NAPI——Node.js 原生模块开发方式变迁','https://www.jianshu.com/p/68b134e5ece3',6,106,'fbc2b1f9',1),
	(9,'2018-09-05 17:16:42','每天一本电子书','https://salttiger.com/',2,144,'ca1d2fc0',1),
	(10,'2018-09-05 21:27:39','MySQL索引背后的数据结构及算法原理','http://blog.jobbole.com/24006/',2,86,'da668f9f',1),
	(11,'2018-09-05 21:29:12','认识 V8 引擎','https://zhuanlan.zhihu.com/p/27628685',6,146,'cc3ae443',1),
	(12,'2018-09-07 10:21:02','C++的静态联编和动态联编','https://www.cnblogs.com/GyForever1004/p/8443241.html',5,68,'69114a2b',1),
	(13,'2018-09-10 21:22:20','2017 前端大事件和趋势回顾，2018 何去何从？','https://mp.weixin.qq.com/s/LvooedOYCJzM8G20Tlw0HQ?',6,93,'6784fdaa',1),
	(14,'2018-09-10 21:22:38','讲讲PWA','https://segmentfault.com/a/1190000012353473',6,118,'0a120293',1),
	(15,'2018-09-10 21:34:57','关于PWA落地问题的思考','https://blog.csdn.net/horkychen/article/details/67943963',6,132,'3f967dbe',1),
	(16,'2018-09-11 10:43:27','GotW #102: Exception-Safe Function Calls','https://herbsutter.com/gotw/_102/',5,97,'cb0c9304',1),
	(17,'2018-09-12 10:02:39','Memory Management part 1 of 3: The Allocator','http://allenchou.net/2013/05/memory-management-part-1-of-3-the-allocator/',5,110,'3305bb8c',1),
	(18,'2018-09-12 11:09:07','When should static_cast, dynamic_cast, const_cast ','https://stackoverflow.com/questions/332030/when-should-static-cast-dynamic-cast-const-cast-and-reinterpret-cast-be-used',5,139,'dc21d86f',1),
	(19,'2018-09-19 09:26:28','夜深人静写算法（二） - 动态规划','http://cppblog.com/menjitianya/archive/2015/10/23/212084.html',7,112,'052cd2d1',1),
	(20,'2018-09-28 16:12:19','husky git hooks','https://www.npmjs.com/package/husky',2,103,'78d9eb35',1),
	(21,'2018-09-28 16:14:33','Object.assign的正确使用','https://segmentfault.com/a/1190000013167556',6,121,'86ba6798',1),
	(22,'2018-09-29 10:26:17','Koa2进阶学习笔记','https://chenshenhai.github.io/koa2-note/',6,126,'7ba745a4',1),
	(23,'2018-09-29 11:25:01','分布式系统的事务处理','http://www.infoq.com/cn/articles/distributed-system-transaction-processing',8,90,'84f1e9c5',1),
	(24,'2018-09-30 09:02:49','跨域请求传递Cookie问题','https://www.cnblogs.com/nuccch/p/7875189.html',6,155,'fa6eb184',1),
	(25,'2018-10-25 19:07:52','在 Kindle 上阅读 RSS 新闻','http://reabble.com/',3,71,'3f0e0eb3',1),
	(26,'2018-11-27 14:26:51','C/C++面向WebAssembly编程','https://github.com/3dgen/cppwasm-book',5,75,'a5df4c7e',1),
	(27,'2019-01-05 09:17:40','网站性能分析','https://gtmetrix.com',6,40,'2c7c325f',1),
	(28,'2019-01-07 03:43:05','如何为 ThinkJS 3 网站优化 TTFB 时间','https://imququ.com/post/reduce-ttfb-on-thinkjs3-website.html',6,44,'e9ce8c91',1),
	(29,'2019-01-14 11:33:48','图说设计模式','https://github.com/me115/design_patterns',8,36,'39267d65',1),
	(30,'2019-01-16 01:03:24','Java工程师进阶知识完全扫盲','https://github.com/doocs/advanced-java',6,45,'65e3b780',1);
...
LOCK TABLES `un_category_config` WRITE;
/*!40000 ALTER TABLE `un_category_config` DISABLE KEYS */;

INSERT INTO `un_category_config` (`cid`, `aid`)
VALUES
	(1,10),
	(1,16),
	(1,23),
...
/*!40000 ALTER TABLE `un_category_config` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `un_chat` WRITE;
/*!40000 ALTER TABLE `un_chat` DISABLE KEYS */;

INSERT INTO `un_chat` (`id`, `username`, `content`, `time`)
VALUES
	(61,'luckyscript','test','2018-07-18 14:53:56'),
	(62,'luckyscript','w\'s','2018-07-21 13:02:39'),
	(63,'luckyscript','lalla','2018-09-06 16:55:33');

/*!40000 ALTER TABLE `un_chat` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `un_nav` WRITE;
/*!40000 ALTER TABLE `un_nav` DISABLE KEYS */;

INSERT INTO `un_nav` (`name`, `path`, `show`, `sort`)
VALUES
	('About','/about',1,0),
	('Archive','/archive',1,1),
	('Link','/link',1,0),
...
/*!40000 ALTER TABLE `un_nav` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `un_tweet` WRITE;
/*!40000 ALTER TABLE `un_tweet` DISABLE KEYS */;

INSERT INTO `un_tweet` (`id`, `content`, `time`, `author`)
VALUES
	(8,'blog算是正式上线吧。mark一下。感觉好多东西都得修改额额额。','2018-07-18 02:55 pm','luckyscript'),
	(9,'啊啊啊。。。服务器时间也不对。不是+8的时间。现在是晚上10：56.','2018-07-18 02:56 pm','luckyscript'),
	(10,'test','2018-07-18 10:58 pm','luckyscript'),
	(11,'骚年，你要知道，想成为和热爱，是两回事。','2018-07-25 12:15 am','luckyscript'),
	(12,'如果成员是const、引用、或者某种未提供默认构造函数类类型，我们必须通过构造函数初始值列表来为他们提供初值。','2018-08-01 10:10 pm','luckyscript'),
	(13,'CString：CString是MFC或者ATL中的实现，是MFC里面封装的一个关于字符串处理的功能很强大的类，只有支持MFC的工程才能使用。如在linux上的工程就不能用CString了，只能使用标准C++中的string类了。在MFC中使用不需要自己加，但在另外的程序中需要加入#include<CString>（CString）\n\nstring：string为标准模板类(STL)定义的字符串类，已纳入C++标准中。另外因为string类是在标准C++库中，使用之前需要声明名称空间std；而CString类并不在std命名空间中，因为它并不是c++标准库，只是一个微软的封装库。所以string类的程序移植性更好。同时，string类与CString类的方法接口也不太一样。一般我们使用cout重载stringl类，而不是CString类\n\nstring.h:c语言中关于字符数组的函数定义的头文件，常用函数有strlen，strcpy，strcmp等，与string类无半点关系，所以头文件<string>、<string.h>是没有关系的两个东西   ','2018-08-09 11:17 am','luckyscript'),
	(14,'写代码脑子抽筋的话，有时候还真难纠正。','2018-08-14 11:58 pm','luckyscript'),
	(15,' Each function template specialization instantiated from a template has its own copy of any static variable.\n\nThis means we get two instantiations of f, one for T=int, and one for T=double. Thus, i is shared between the two int calls, but not with the double call.','2018-08-16 04:37 pm','luckyscript');

/*!40000 ALTER TABLE `un_tweet` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	(1,'luckyscript','d82f9a0d2729d56d8c8f02141ced7824','main.lukai@gmail.com','http://www.luckyscript.me','luckyscript',0,0,0,'admin',NULL,NULL);
